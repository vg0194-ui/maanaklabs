export const sampleGuideSteps = [
  {
    ...
    english: [
      ...
      "Do not send only top-layer seed.",
    ],
    hindi:
      "लॉट के अलग-अलग स्थानों या बोरियों से नमूना लें, अच्छी तरह मिलाएँ, और केवल ऊपर की परत का बीज न भेजें।",
  },
  {
    number: "02",
    ...
    english: [
      ...
      "Submit request and complete payment.",
    ],
    hindi: "लॉगिन करें, फसल और लॉट विवरण भरें, परीक्षण चुनें और भुगतान पूरा करें।",
  },
  {
    number: "03",
    ...
    english: [
      ...
      "Each sample will have unique Sample ID and Request Number.",
    ],
    hindi: "भुगतान के बाद PDF डाउनलोड करें और हर नमूने की स्लिप प्रिंट करें।",
  },
  {
    number: "04",
    ...
    english: [
      ...
      "Seal the packet properly and do not mix two samples in one packet.",
    ],
    hindi: "हर नमूना अलग स्वच्छ पैकेट में रखें, सही स्लिप लगाएँ और अच्छी तरह सील करें।",
  },
  {
    number: "05",
    ...
    english: [
      ...
      "Make sure all sample slips match the packed samples.",
    ],
    hindi: "सभी पैकेट एक मास्टर बैग में रखें और अनुरोध पत्र अंदर डालें।",
  },
  {
    number: "06",
    ...
    english: [
      ...
      "Add sender mobile number on the package.",
    ],
    hindi: "मास्टर बैग के बाहर लैब पता लेबल साफ़ दिखने वाली जगह पर चिपकाएँ।",
  },
  {
    number: "07",
    ...
    hindi: "कूरियर, पार्सल, ट्रांसपोर्ट या स्वयं जमा करें और ट्रैकिंग सुरक्षित रखें।",
  },
  {
    number: "08",
    ...
    hindi: "लॉगिन करके स्थिति देखें: सैंपल प्रतीक्षित से लेकर रिपोर्ट पूर्ण होने तक।",
  },
];
